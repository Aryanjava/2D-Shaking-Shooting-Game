...
const introMusic = new Audio("./music/Doom_Intro.mp3");
...
const aryan = new Player(playerPosition.x, playerPosition.y, 15, "white");
const weapons = [];
const hugeWeapons = [];
const enemies = [];
const particles = [];
...
function animation() {
  ...
  enemies.forEach((enemy, enemyIndex) => {
    ...
    if (distanceBetweenPlayerAndEnemy - aryan.radius - enemy.radius < 1) {
